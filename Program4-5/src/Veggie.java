...
///////////////////////////////////////////////////////////////////////////////////////
//This file contains the implantation of the Veggie class. It contains every function
...
//Algorithms
//
//This file contain the veggie class and its implantation. The class manges the veggie
...
//Veggie -"Is a"-> Toppings
/////////////////////////////////////////////////////////////////////////////////////////
public class Veggie extends Toppings{
    /**
     * Default Constructor
     ...
     */
    public Veggie() throws IOException {
        type = new String("Veggie");
        int size = read_number_lines("Veggie.txt");
        choices = new int[size];
        to_display = new String[size];
        read_and_populate("Veggie.txt",to_display, size);
    }
    /**
     * Copy Constructor
    ...
    /**
     *Step 1: call and return the parent's function non mandatory with Scanner and 0 to read and random respectively.
     */
    @Override
    ...
    /**
     *Step 1: call and return the parent's function non mandatory with Scanner and 0 to null and random respectively.
     */
    @Override
